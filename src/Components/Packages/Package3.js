...
import packageImage from '../../img/packege-3.jpg'; // Adjust the path

export default function Package3() {
  return (
    <div className="d-flex" id="package">
      <img src={packageImage} alt="Package 1" />
      <div className="p-5">
            <h4>Santorini Island's Weekend Vacation</h4>
      ...
      <div className="text-center p-5 text-light" id="bg-package">
            <p>(25 reviews)</p>
            <p><span className="fs-2">$250</span><br/>/ per person</p>
