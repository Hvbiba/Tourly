...
import packageImage from '../../img/packege-2.jpg'; 
...
export default function Package2() {
  return (
    <div className="d-flex" id="package">
      ...
      <div className="p-5">
            <h4>Summer Holiday To The Oxolotan River</h4>
            <p> 
                Laoreet, voluptatum nihil dolor esse quaerat<br /> 
                mattis explicabo maiores,est aliquet porttitor!<br/> 
                Eaque, cras, aspernatur.
            </p>
            <p> 
      ...
      <div className="text-center p-5 text-light" id="bg-package">
            <p>(25 reviews)</p>
            <p><span className="fs-2">$550</span><br/>/ per person</p>
